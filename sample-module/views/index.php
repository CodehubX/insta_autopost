...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= PLUGINS_URL."/sample-module/assets/css/core.css?v=".VERSION ?>">

        <title><?= __("Sample Module") ?></title>
    </head>

    <body>
        <?php 
            $Nav = new stdClass;
            $Nav->activeMenu = "sample-module";
        ...
        <script type="text/javascript" src="<?= PLUGINS_URL."/sample-module/assets/js/core.js?v=".VERSION ?>"></script>
